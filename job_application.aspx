    ...
    <asp:Panel ID="pnl_form1" runat="server" GroupingText="Apply for a job opportunity">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txt_phone" runat="server" />
                ...
                <asp:RegularExpressionValidator ID="rev_phone" runat="server" Text="Invalid email" ControlToValidate="txt_phone" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[0-9]*$" ErrorMessage="Please input a number" ValidationGroup="Group1" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td><asp:Label ID="lbl_upload_cover_letter" runat="server" Text="Cover letter: " /></td>
            <td><asp:FileUpload ID="file_upload_cover_letter" runat="server" /></td>
        </tr>
        </table>
        <br />
